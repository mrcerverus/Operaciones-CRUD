# Generated by Django 4.2 on 2024-05-23 18:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_user', models.CharField(choices=[('ARRENDADOR', 'arrendador'), ('ARRENDATARIO', 'arrendatario')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ManyToManyField(to=settings.AUTH_USER_MODEL, verbose_name='Usuario')),
            ],
        ),
        migrations.CreateModel(
            name='Region',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imagen', models.ImageField(blank=True, null=True, upload_to='inmuebles/%Y/%m/%d')),
                ('inmueble', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.inmueble', verbose_name='Inmueble')),
            ],
        ),
        migrations.AddField(
            model_name='comuna',
